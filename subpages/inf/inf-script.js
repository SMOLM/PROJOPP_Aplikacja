...
let questions= [
    ["Gpu co to?", "Karta graficzna"],
    ["Czy na procesor należy nakłądać paste termiczną?", "Tak"],
];
...
let questions2= [
	["Rozwiń skrót LAN?", "Local Area Network"],
	["Rozniń skrót WAN?", "Wide Area Network"],
];
...
let questions3= [
    ["Czy bezpiecznie jest otwierać linki od nieznanych osób?","Nie"],
    ["Czy bezpiecznie jest ustawiać takie samo hasło w kilku miejscach?", "Nie"],
];
