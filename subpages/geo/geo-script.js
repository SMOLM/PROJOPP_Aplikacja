...
let questions= [
    ["Podaj nazwe kontynentu na jakim leży Polska", "Europa"],
    ["Podaj nazwe kontynentu na jakim leży Azja", "Japonia"],
];
...
let questions2= [
	["Najwyższy szczyt na ziemi?", "Mount Everest"],
...
let questions3= [
    ["Najsłońsze może świata?", "Morze martwe"],
    ["Największym oceanem na świecie jest?", "Pacyfik"],
];
