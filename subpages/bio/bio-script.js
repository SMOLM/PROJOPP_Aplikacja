...
let questions= [
    ["Czy w ludzkim żołądku znajduje się bardzo silny kwas?", "Tak"],
    ["Które jelito jest dłuższe?", "Cienkie"],
];
...
let questions2= [
	["Jakie dwie główne żyły wychodzą z serca?", "Tętnice"],
	["Których krwinek mamy więcej czerwonych czy białych?", "Czerwonych"],
];
...
let questions3= [
    ["Czy funkcja pełni funkcje ochronną?","Tak"],
    ["Czy gruczoł potowy występuje praktycznie na całym ciele?", "Tak"],
];
